...
namespace CPPTools::Fmt {
	...
	void Formater::BufferParseInt(T i) {
		if (m_FormatData.HasSpec) {
			...
			case ValueIntPrint::Int:
				if (m_FormatData.ShiftType == ShiftType::Nothing)	{ FormatFunc::FormaterParseInt(*this, i); return; }
			...
			case ValueIntPrint::Bin:
				if (m_FormatData.ShiftType == ShiftType::Nothing)	{ FormatFunc::FormaterParseIntAsBin(*this, i, m_FormatData.Precision); return; }
			...
			case ValueIntPrint::Hex:
				if (m_FormatData.ShiftType == ShiftType::Nothing)	{ FormatFunc::FormaterParseIntAsHex(*this, i, m_FormatData.Precision); return; }
			...
			case ValueIntPrint::Oct:
				if (m_FormatData.ShiftType == ShiftType::Nothing)	{ FormatFunc::FormaterParseIntAsOct(*this, i, m_FormatData.Precision); return; }
	...
	void Formater::BufferParseUInt(T i) {
		if (m_FormatData.HasSpec) {
			switch (m_FormatData.IntPrint) {
				case ValueIntPrint::Int:
					if (m_FormatData.ShiftType == ShiftType::Nothing)	{ FormatFunc::FormaterParseUInt(*this, i); return; }
					else												{ FormatFunc::FormaterParseUInt(*this, i, m_FormatData.ShiftType, m_FormatData.ShiftValue, m_FormatData.ShiftPrint); return; }
				case ValueIntPrint::Bin:
					if (m_FormatData.ShiftType == ShiftType::Nothing)	{ FormatFunc::FormaterParseUIntAsBin(*this, i, m_FormatData.Precision); return; }
				...
				case ValueIntPrint::Hex:
					if (m_FormatData.ShiftType == ShiftType::Nothing)	{ FormatFunc::FormaterParseUIntAsHex(*this, i, m_FormatData.Precision); return; }
				...
				case ValueIntPrint::Oct:
					if (m_FormatData.ShiftType == ShiftType::Nothing)	{ FormatFunc::FormaterParseUIntAsOct(*this, i, m_FormatData.Precision); return; }
	...
	void Formater::BufferParseFloat(T i) {
		if (m_FormatData.HasSpec) {
			if (m_FormatData.ShiftType == ShiftType::Nothing)	{ FormatFunc::FormaterParseFloat(*this, i, m_FormatData.FloatPrecision); return; }
